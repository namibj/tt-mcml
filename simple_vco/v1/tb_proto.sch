...
N 560 -220 580 -220 {lab=#net2}
N 560 -180 580 -180 {lab=#net3}
...
N 700 -160 720 -160 {lab=#net3}
N 880 -200 900 -200 {lab=#net4}
N 100 -450 100 -430 {lab=VDD}
N 200 -450 200 -430 {lab=#net5}
...
N 580 -220 700 -180 {lab=#net2}
N 580 -180 700 -160 {lab=#net3}
...
C {devices/vsource.sym} 390 -400 0 0 {name=V3 value=0.5}
